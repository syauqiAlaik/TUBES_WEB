      ...
      <div class="relative p-4 max-w-xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" >
              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="/pembimbing/add-pembimbing" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Nama Bimbingan</div>
                        <input type="text" id="aktivitas" name="nama_kegiatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Nama Bimbingan" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Waktu Bimbingan</div>
                        <div class="relative">
                            ...
                            <input type="text" id="datepicker" name="waktu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Bimbingan" required> </div>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
