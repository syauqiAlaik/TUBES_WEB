      ...
      <div class="relative p-4 max-w-xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" >
              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="/penguji/add-penguji" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        ...
                        <input type="text" id="aktivitas" name="mahasiswa_nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Mahasiswa" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Waktu Ujian</div>
                        <div class="relative">
                            ...
                            <input type="text" id="datepicker" name="waktu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Ujian" required> </div>
                    </div>
                   
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">No. Berita Acara</div>
                        <input type="text" id="aktivitas" name="no_sk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan No Berita Acara" required>
                    </div>
            <div class="grid grid-cols-2 mb-5">
