...
<head>
    ...
    <title>Pengembangan Program Kuliah</title>
    @php
...
@endif
    ...
    <div class="flex ms-72 mt-5 class font-inter flex-col">
        <div class="grid grid-cols-2 bg-white  w-11/12 h-16 ps-5 items-center">
            <h1>Pengembangan Program Kuliah </h1>
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{$item->matkul_pengembangan}}
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{$item->deskripsi_pengembangan}}
                        </th>
                        <td class="px-6 py-4">
      ...
      <div class="relative p-4 max-w-xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" >
              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="/pengembangan-pk/add-pengembangan-pk" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Matkul Dikembangkan</div>
                        <input type="text" id="aktivitas" name="matkul_pengembangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Matkul" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Deskripsi Pengembangan</div>
                        <input type="text" id="aktivitas" name="deskripsi_pengembangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Deskripsi" required>
                    </div>
            <div class="grid grid-cols-2 mb-5">
