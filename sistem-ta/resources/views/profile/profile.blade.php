                    ...
                    <div class="grid grid-cols-2 h-full">
                        <div class="flex items-center justify-center">
                            <div class="aspect-square w-52">
                                <img src="assets/PDF/foto.jpg" class="rounded-full aspect-square object-cover float-right" alt="">
                            </div>
                        </div>
                        <div>
                            <div class="pe-2 pb-1">
                            ...
                            <div class="pe-2 pb-1">
                                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIDN</label>
