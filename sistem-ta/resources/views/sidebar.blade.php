...
<body class="bg-blue">
 ...
 <!-- Ganti background dengan warna abu-abu -->
      ...
      <nav class="bg-blue-500 border-gray-200 w-full flex justify-end items-center h-20"> <!-- Ganti background dengan warna biru -->
