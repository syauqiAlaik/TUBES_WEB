...
class JabatanController extends Controller
{
    public function index()
    {
        if (Auth::check()) {
            ...
            $jabatan = Jabatan::where('user_id', Auth::user()->id)->paginate(10);
    ...
    public function store(Request $request): RedirectResponse
    {
        try {
            if (Auth::check()) {
                ...
                $lampiran_jabatan = $request->file('lampiran_jabatan');
                $lampiran_jabatan_path = $lampiran_jabatan->store('public');
                ...
                Jabatan::create([
                    ...
                    'periode_akhir' => $akhir,
                    'no_sk' => $request->no_sk,
                    'lampiran_jabatan' => $lampiran_jabatan_path,
